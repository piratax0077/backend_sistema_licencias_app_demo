...
use App\Http\Controllers\FiscalizacionWebController;
...
Route::get('/fiscalizacion', [FiscalizacionWebController::class, 'index'])->name('fiscalizacion.index');
Route::post('/fiscalizacion/solicitudes', [FiscalizacionWebController::class, 'store'])->name('fiscalizacion.store');
